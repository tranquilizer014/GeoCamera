...
/**
 * Wraps an EGL context/surface bound to a MediaCodec encoder's input Surface, so GL drawing
 * calls followed by [swapBuffers] deliver the composited frame directly into the encoder.
 */
